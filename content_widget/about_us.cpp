...
void about_us_dialog::init()
{
	...
	QPixmap pixmap("./Resources/img/360safe.png");
...
void about_us_dialog::translateLanguage()
{
...
void about_us_dialog::paintEvent(QPaintEvent* event)
{
