...
void skin_widget::initCenter()
{
	...
	for (int i = 0; i < 8; i++)
	{
		change_skin_widget* change_skin_widget_ = new change_skin_widget(); //重名了,change_skin_widget -> change_skin_widget_
...
void skin_widget::varyfySkin()
{
	...
	change_skin_widget* change_skin_widget_ = qobject_cast<change_skin_widget*>(object);   ////重名了,change_skin_widget -> change_skin_widget_
