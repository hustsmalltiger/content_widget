...
void setting_dialog::initTab4()
{
	...
	language_combo_box->addItem("chinese", 1);   // UI_ZH不能编译，直接赋值，将UI_ZH改为1
	language_combo_box->addItem("english", 0);   // UI_EH不能编译，直接赋值，将UI_EH改为0
...
void setting_dialog::initCenter()
{
...
void setting_dialog::initBottom()
{
...
void setting_dialog::translateLanguage()
{
...
void setting_dialog::paintEvent(QPaintEvent* event)
{
...
void setting_dialog::updateConfig()
{
