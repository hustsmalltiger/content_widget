...
kill_mummy_widget::kill_mummy_widget(QWidget* parent)
	: QWidget(parent)
{
	...
	QPixmap pixmap("./Resources/img/killMummyWidget/tip.png");
	...
	//ÉèÖÃÍ¼±ê
	QSize size(123, 115);
	QPixmap fast_scan_pixmap("./Resources/img/killMummyWidget/fast_scan.png");
	...
	QPixmap full_scan_pixmap("./Resources/img/killMummyWidget/full_scan.png");
	...
	QPixmap custom_scan_pixmap("./Resources/img/killMummyWidget/custom_scan.png");
...
kill_mummy_widget::~kill_mummy_widget()
{

}

void kill_mummy_widget::translateLanguage()
{
