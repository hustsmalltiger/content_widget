...
void system_tray::translateLanguage()
{
	//放在托盘图标上时候显示
...
void system_tray::createTopAction()
{
...
void system_tray::createBottomAction()
{
...
void system_tray::createAction()
{
	this->setIcon(QIcon("./Resources/img/safe.png"));
...
bool system_tray::eventFilter(QObject* obj, QEvent* event)
{
